...
class Route_Concatenation:
    ...
    def main(self):
        INPUT = "./best-ebus/scenario/eBuS/data_basis/solution_cicerostrasse.json"
        DICT = "./best-ebus/scenario/eBuS/preprocessing_output/trips_cicerostrasse.txt"
        ROUTES = "./best-ebus/scenario/eBuS/preprocessing_output/deadheads_routes_cicero_mueller.rou.xml"
        OUTPUT = "./best-ebus/scenario/eBuS/preprocessing_output/optimized_buses.rou.xml"
